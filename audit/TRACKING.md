...
| # | ID | Sév | Eff | Constat | R1 | R2 | R3 | R4 | R5 | Statut |
|---|----|-----|-----|---------|----|----|----|----|----|--------|
| 1 | `architecture-01` | 🔴 High | M | Endpoints implémentés et documentés mais jamais montés sur le serveur  | ☐ | ☐ | ☐ | ☐ | ☐ | ☐ TODO |
...
| 4 | `protocole-mcp-03` | 🔴 High | S | Endpoints documentés, testés et consommés par le SDK/doctor jamais câb | ☐ | ☐ | ☐ | ☐ | ☐ | ☐ TODO |
...
| 3 | `tests-01` | 🔴 High | S | Les seuils de couverture 100 % ne sont pas appliqués en CI (pnpm test  | ☐ | ☐ | ☐ | ☐ | ☐ | ☐ TODO |
...
| 11 | `tests-04` | 🟠 Med | S | Le hook d'authentification MQTT de production n'est jamais exercé : le | ☐ | ☐ | ☐ | ☐ | ☐ | ☐ TODO |
...
| 23 | `tests-07` | 🟡 Low | S | Race assumée dans channel-smoke : sleep fixe de 1,5 s au lieu d'attend | ☐ | ☐ | ☐ | ☐ | ☐ | ☐ TODO |
