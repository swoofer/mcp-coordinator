...
describe("FileTracker", () => {
  it("logs and retrieves file activity", () => {
    tracker.log({ org_id: "default", session_id: "s1", agent_id: "a1", agent_name: "Agent A", tool_name: "Edit", file_path: "src/auth/middleware.ts" });
  ...
  it("detects hot files", () => {
    tracker.log({ org_id: "default", session_id: "s1", agent_id: "a1", tool_name: "Edit", file_path: "src/shared/types.ts" });
    tracker.log({ org_id: "default", session_id: "s2", agent_id: "a2", tool_name: "Edit", file_path: "src/shared/types.ts" });
  ...
  it("no hot files when single agent", () => {
    tracker.log({ org_id: "default", session_id: "s1", agent_id: "a1", tool_name: "Edit", file_path: "src/auth/index.ts" });
  ...
  it("checks file conflict", () => {
    ...
    expect(tracker.checkFileConflict("default", "src/auth/index.ts", "a1", 60).conflict).toBe(false);
  });
